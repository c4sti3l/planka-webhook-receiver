  ...
  <div class="h-full flex flex-col space-y-6">
    ...
    <div class="card">
      ...
      <div class="flex items-center space-x-2">
        <code
          class="flex-1 bg-gray-100 dark:bg-neutral-800 px-3 py-2 rounded text-sm text-gray-800 dark:text-neutral-300"
        >
          {{ webhookUrl }}
        </code>
    ...
    <div class="card flex flex-col flex-1 min-h-0">
      ...
      <div
        v-else
        class="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar"
      >
        <EventItem
